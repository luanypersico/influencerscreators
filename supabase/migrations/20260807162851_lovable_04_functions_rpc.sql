...
REVOKE EXECUTE ON FUNCTION public."enforce_bergamo_only_integration"() FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public."enforce_bergamo_only_integration"() FROM anon;
REVOKE EXECUTE ON FUNCTION public."enforce_bergamo_only_integration"() FROM authenticated;
REVOKE EXECUTE ON FUNCTION public."enforce_bergamo_only_integration"() FROM service_role;
